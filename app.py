...
model_dir = "E:\Acads 4th Year - 2nd Sem\Thesis\Thesis Website\HTML n CSS\LSTM-v4"
...
stored_count_60s = 0  # Stored value for prediction
...
while True:
    try:
        ...
        stored_count_placeholder.metric("Stored RR for Prediction", stored_count_60s)
    except Exception as e:
